...
def data_extractor_t5(array):
    ...
    datetime_previous_timestamp = timereader(array[0][0], formatstr="%Y-%m-%d %H:%M:%S")
    last_lift = array[0][5]
    ...
    for row in array:
        ...
        this_lift = row[5]
        #binstate1 = binreader16bit(int(row[1]))[-9:-1]
        #binstate2 = binreader16bit(int(row[2]))[-9:-1]
        ...
        floor = (c2 & 0b11110000) >> 4 #Decoding the floor
